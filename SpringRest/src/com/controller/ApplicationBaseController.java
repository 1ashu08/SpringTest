...
*/
    ...
    public ResponseEntity<String> findAllOrders() {
        ...
        return new ResponseEntity<>("In the requet section", HttpStatus.OK);
    ...
    public ResponseEntity<String> createOrder(@RequestBody ApplicationBase app) {
        ...
        return new ResponseEntity<>("In the post method ", HttpStatus.CREATED);
    ...
    public ResponseEntity<String> findOrderById(@PathVariable Long id) {
       ...
       // Optional<Order> order = repository.findById(id);
        ...
        if (true) {
            ...
            return new ResponseEntity<>("Roles found", HttpStatus.OK);
